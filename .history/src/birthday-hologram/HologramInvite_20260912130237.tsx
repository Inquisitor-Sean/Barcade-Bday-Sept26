    ...
    <main className="game-about">
      ...
      <div className="game-grid">
        <section className="game-tile game-quest">
          ...
          <p>
            {copy("questCopy", "Arrive, or don't, I can't tell you what to do")}
          </p>
      ...
      {panel && (
        ...
        >
          {panel === "details" && (
            <>
              ...
              <section>
                ...
                <p>
                  <strong>{copy("noBabies", "NO ACCIDENTAL BABIES")}</strong>
                </p>
              </section>
              ...
              <section>
                ...
                {faqs.map((item) => (
                  <details key={item.id}>
                    <summary>{copy(`${item.id}Q`, item.question)}</summary>
          ...
          {panel === "backpack" && (
            <>
              <a href={links.photos} target="_blank" rel="noopener noreferrer">
                {english ? (
                  <>
          ...
          {panel === "share" && (
            <>
              <img
                ...
                alt={
                  english
                    ? "Scan to open Sean’s birthday invitation"
                    : "Escanea para abrir la invitación de cumpleaños de Sean"
                }
                width={240}
                height={240}
                style={{
